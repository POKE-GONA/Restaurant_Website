				...
				<div class="container">
					...
					<div class="w3ls-header-right">
						<ul> 
							...
							<li class="head-dpdn">
								<a href="Staff_Login.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</a>
							</li> 
							<li class="head-dpdn">
								<a href="Staff_Register.php"><i class="fa fa-user-plus" aria-hidden="true"></i> Signup</a>
							</li> 
							<li class="head-dpdn">
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="w3pages"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Menu <span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a href="Category.php">Staff Category</a></li>
										<li><a href="MenuType.php">Staff Menu Type</a></li>
										<li><a href="Menu.php">Staff Menu</a></li> 
										<li><a href="MenuItem.php">Staff Menu Item</a></li>    
									</ul>
								</li>

								<li><a href="about.html">About</a></li> 

								<li class="w3pages"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Admin <span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a href="Township.php">Staff Township</a></li>
										<li><a href="Staff_Update.php">Staff Update</a></li>
										<li><a href="Staff_Logout.php">Staff Logout</a></li>   
									</ul>
								</li> 
				...
				<div class="agileits_search">
					<form action="#" method="post">
						...
						<select id="agileinfo_search" name="agileinfo_search" required="">
							<option value="">Popular Township</option>
							<option value="navs">Tamwe</option>
							<option value="quotes">SouthOkkalapa</option>
							<option value="videos">Insein</option>
							<option value="news">Ahlone</option>
							<option value="notices">Kyeemyindaing</option>
