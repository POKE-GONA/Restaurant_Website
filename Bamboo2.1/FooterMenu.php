	...
	<div class="add-products">  
		<div class="container">
			...
			<div class="add-products-row">
				<div>
					<a href="BookingMenuDisplay.php?MID=3"> 
						<h4>Get <span>10%<br>Cashback</span></h4>
						<h5>Special Offer Today Only</h5>
						<h6>Order Now <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
					<img src="images/Unlimited Time BBQ.jpg" alt=" " width="400" height="400">
				</div>
			</div>
			<hr/>

			<div align="left" class="add-products-row">
				<div>
					<a href="BookingMenuDisplay.php?MID=1"> 
						<h4>GET Upto<span><br>5% Offer</span></h4>
						<h5>On Order Lunch Today</h5>
						<h6>Order Now <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
					<img src="images/Unlimited Time BBQ and Hot pot.jpg" alt=" " width="400" height="400">
				</div> 
