...
<hr/>
<head>
	<title>OItem Detail</title>
</head>
<body>
		<form align="center" action="OrderingList.php" method="GET">
			...
			<tr>
				...
				<table align="center" width="600px" height="400px" border="2px">
						...
						<tr>
							<td align="center">Ordering Set</td>
							<td align="center">
							<input type="number" name="txtOrderingquantity" min="1">
							</td>
						</tr>
						...
						<tr>
							<td></td>
							<td align="center">	
							<input type="submit" name="btnadd" value="Add to Ordering"/></td>
						</tr>
				</table>
				</tr>
				</td>
